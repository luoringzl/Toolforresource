...
contextBridge.exposeInMainWorld('desktopAPI', {
  ...
  databaseDiagnostics: () => ipcRenderer.invoke('db:diagnostics'),
  listRecoveryPoints: () => ipcRenderer.invoke('db:recoveryPoints'),
  restoreRecoveryPoint: (name) => ipcRenderer.invoke('db:restoreRecoveryPoint', name),
  clearRecoveryPoints: () => ipcRenderer.invoke('db:clearRecoveryPoints'),
