...
makeWorkbook(projectHeaders, [
  ...
  ['项目类型', '填写：测试项目、正式合作项目。测试项目应同时填写测试结果。'],
  ['启动时间', '填写项目正式启动日期，用于项目资料库的启动时间起止筛选。'],
  ['制作要求', '填写：片段制作、剧集制作、全片制作。片段/全片填写场数，剧集制作填写集数。'],
  ['结算情况', '填写：损稿、客户撤稿、正常结算、部分结算、不结算。'],
  ['测试结果', '仅测试项目填写：测试通过、测试未通过、转正式合作、待定。'],
  ['项目状态', '可填写：待启动、制作中、资产制作中、资产制作完成、视频制作中、视频制作完成、反馈修改中、待验收、暂停、已完成、已取消。已完成、已完结、已取消项目不产生用人需求。'],
  ['人员字段', '项目负责人/导演、编导、PM、美术监制、视频制作人员、资产制作人员均支持多人，多人用顿号分隔；编导可缺省，有导演时美术监制也可缺省。'],
...
makeWorkbook(peopleHeaders, [
  ...
  ['职位', '支持多选，多项用中文顿号或分号分隔。可填写：总经理、人事总监、项目经理 / PM、AI动画师、导演、UE蓝图动画师、UE场景设计师、AI后期、AI技术研究、CG资产师、商务、导演助理等。'],
  ['技能与等级', '格式：技能|等级；多项用中文分号分隔。示例：AI视频制作|高级；剪辑|中级。'],
  ['制作能力', '格式：技能|数量|单位|适用难度|备注。示例：AI视频制作|2|分钟/天|电影级|；AI资产制作|10|张/天||。'],
  ['AI项目及产能占用', '格式：项目名|占用百分比|项目角色|结束日期|资产制作数|资产优化数|视频分钟|高难度镜头分钟|实际产出说明；多项用中文分号分隔。未用到的产出字段可留空。'],
  ...
  ['在岗状态', '可填写：在岗、请假、异动、停薪留岗、外包、离职、离岗。只有“在岗”人员进入可调度和项目候选列表。']
], '人员资料导入模板.xlsx');
